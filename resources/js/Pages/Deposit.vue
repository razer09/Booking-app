        ...
        <div class="py-12">
            <div class="max-w-xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6 space-y-2">
                    <h1 class="text-xl font-bold text-gray-800 uppercase ">Deposit</h1>
                    <p class="mt-1 text-sm text-gray-600">Deposit money to your account</p>
                    <TextInput
                        id="amount"
                        v-model="form.amount"
                        type="number"
